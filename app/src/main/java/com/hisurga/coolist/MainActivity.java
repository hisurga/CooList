...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(com.hisurga.coolist.R.layout.activity_main);
        Toolbar toolbar = (Toolbar) findViewById(com.hisurga.coolist.R.id.toolbar);
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(com.hisurga.coolist.R.id.fab);
